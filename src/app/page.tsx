...
export default function HomePage() {
  return (
    <div className="relative mx-auto flex min-h-full max-w-5xl flex-col gap-10 px-4 py-16 sm:px-8">
      ...
      <footer className="border-t border-zinc-200 pt-8 text-center text-xs text-zinc-500 dark:border-white/10 dark:text-zinc-400">
